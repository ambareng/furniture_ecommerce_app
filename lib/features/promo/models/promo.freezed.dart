...
abstract class $PromoCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String name, double discount});
}
...
class _$_Promo implements _Promo {
  _$_Promo({required this.id, required this.name, required this.discount});
  ...
  @override
  String toString() {
    return 'Promo(id: $id, name: $name, discount: $discount)';
  }
...
abstract class _Promo implements Promo {
  factory _Promo(
      ...
      required final double discount}) = _$_Promo;
